    ...
    return (
        <main className='w-full mt-[8vh] py-20 flex flex-col justify-center items-center'>
            <div className='w-full flex flex-col justify-start items-center space-y-4 px-5 md:px-10 lg:px-20 pb-20'>
                <h3 className='text-black text-3xl lg:text-5xl font-bold mb-5'>  Flipkart shipping label crop </h3>
                <div className='flex flex-col justify-start items-start space-y-2'>
                    <h3 className='text-black text-4xl font-bold mb-5'>Flipkart shipping label crop</h3>
                    <p >Last updated: March 14, 2023</p>

                    <h3 className='text-black text-4xl font-bold mb-5'>How to use pdfcrops FlipKart label crop tool</h3>

                    <p >The Flipkart label crop tool is essential if you are a Flipkart seller, below are some of the benefits and processes of how to use the Flipkart label crop tool.</p>
                    <h2>Benefits of using pdfcrops to crop Flipkart labels</h2>

                    <ul>
                        <li><p> 1.  The fastest way to crop Flipkart shipping labels.</p></li>
                    ...
                    <p >Once your Flipkart shipping label pdf is generated you can use the same pdf here to crop labels. You don’t have to do any other process on your Flipkart shipping label pdf file. </p>
                    <p > Select Flipkart in <u><a href="http://localhost:3000/tools/pdf/crop">pdfcrops.com/tools</a> </u></p>
