...
export default function Home({ data }) {
  return (
       ...
       <div className='w-full flex flex-col justify-start items-center space-y-4 px-5 md:px-10 lg:px-20 pb-20'>
           <h3 className='text-black text-3xl lg:text-5xl font-bold mb-5'>  Meesho shipping label crop </h3>
           <div className='flex flex-col justify-start items-start space-y-2'>
              <h3 className='text-black text-4xl font-bold mb-5'>Meesho shipping label crop</h3>
           <p >Last updated: March 14, 2023</p>
           
           <h3 className='text-black text-4xl font-bold mb-5'>How to use pdfcrops Meesho label crop tool</h3>
   
           <p >The Meesho label crop tool is essential if you are a Meesho seller, below are some of the benefits and processes of how to use the Meesho label crop tool.</p>
           <h2>Benefits of using pdfcrops to crop Meesho labels</h2>
           
           <ul>
               <li><p> 1.  The fastest way to crop Meesho shipping labels.</p></li>
