    ...
    <div className='pt-4 sm:pt-10 lg:pt-12'>
      <footer className="max-w-screen-2xl px-4 md:px-8 mx-auto bg-gray-100">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 border-t gap-12 lg:gap-8 pt-10 lg:pt-12 mb-16">
          ...
          {/* <!-- nav - start --> */}
          <div>
            <div className="text-gray-800 font-bold tracking-widest uppercase mb-4">Navigate</div>
          ...
          <div>
            ...
            <nav className="flex flex-col gap-4">
              <div>
                <Link href="/contact" className="text-gray-500 hover:text-indigo-500 active:text-indigo-600 transition duration-100">Contact</Link>
              </div>
