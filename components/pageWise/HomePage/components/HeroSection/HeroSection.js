...
const HeroSection = () => {
  return (
    <section className='w-full h-[45vh] lg:h-[70vh] xl:h-[60vh] flex flex-col justify-start items-center lg:flex-row lg:items-center lg:justify-center lg:bg-gradient-to-b from-sky-500 via-fuchsia-400 to-gray-100'> 
